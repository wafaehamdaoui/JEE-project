...
<main id="main" class="main">
    ...
    <div class="pagetitle">
      ...
      <form action="newResource" method="get" class="text-md-end">
   		 <button type="submit" class="btn m-1 text-light btn-sm" style="background-color: #90e0ef;">New Resource</button>
	  </form>
    </div><!-- End Page Title -->
           ...
           <div class="card-body pb-0">
    			<table class="table table-info">
                  <thead>
                    ...
                    <tbody>
            <% for (Resource resource : (List<Resource>) request.getAttribute("resourceList")) { %>
                <tr class="table-light">
                    ...
                    <td class="table-light">
                        <a href="editResource?id=<%= resource.getId() %>"class="btn"><i class="bi bi-pencil-square"></i></a>
                        <a onclick=" return confirm('Are you sure?')" href="deleteResource?id=<%= resource.getId() %>" class="btn" ><i class="bi bi-trash-fill"></i></a>
                    </td>
                </tr>
            <% } %>
         </tbody>
