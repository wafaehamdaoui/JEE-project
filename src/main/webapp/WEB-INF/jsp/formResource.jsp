...
<main id="main" class="main">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="/resourceList">${action} Resource</a></li>
			...
			<%String action = (String)request.getAttribute("action");
				...
				<div>
                    ...
                    <select name="type" id="type">
                       <option value="Computer" ${"Computer".equals(resource.type) ? "selected" : ""}>Computer</option>
                       <option value="Sport" ${"Sport".equals(resource.type) ? "selected" : ""}>Sport</option>
                       <option value="Workspace" ${"Workspace".equals(resource.type) ? "selected" : ""}>Workspace</option>
                    </select>
                </div>
				<div>
					<label>Location</label>
					<input type="text" name="location" value="${resource.location}">
				</div>
				<div>
					<label>Image</label>
					<input type="text" name="image" value="${resource.image}">
				</div>
				<div>
                    <label for="status">Status</label>
                    <select name="status" id="status">
                       <option value="available" ${"available".equals(resource.status) ? "selected" : ""}>Available</option>
                       <option value="unavailable" ${"unavailable".equals(resource.status) ? "selected" : ""}>Unavailable</option>
                    </select>
                </div>
